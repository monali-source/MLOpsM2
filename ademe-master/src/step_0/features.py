...
from data/original/dpe-v2-tertiaire-2.csv
to data/source/dpe_tertiaire_20240307.csv
run with
%run step_0/features.py
...
if __name__ == "__main__":
    ...
    output_file = (
        f"./data/source/dpe_tertiaire_{datetime.datetime.now().strftime('%Y%m%d')}.csv"
    )
